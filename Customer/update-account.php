<?php
    ...
    $editdetails = "SELECT * FROM USERS WHERE USER_ID = '$url_uid'";
    ...
    if(isset($_POST['update'])){
        $query="UPDATE USERS SET USER_NAME ='$_POST[name]', USER_EMAIL='$_POST[email]', USER_CONTACT ='$_POST[contact]' WHERE USER_ID ='$user_id'";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/update-account.css">
</head>
<body>
            ...
            <div class="log-section">
                ...
                <div class="log-card">
                    <form id="" action="" method="post">
                        ...
                        <input type="text" name="name" placeholder="Username" value="<?php echo $eachrow['USER_NAME'];?>" required>
                        <input type="email" name="email" placeholder="Email" value="<?php echo $eachrow['USER_EMAIL']; ?>" required>
                        <input type="text" name="contact" placeholder="Contact Number" value="<?php echo $eachrow['USER_CONTACT']; ?>" required>
