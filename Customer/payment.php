<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(!empty($_POST['shop_id'])){
            ...
            $paypal_result = oci_parse($conn, $paypal_query);
                ...
                <div class="top-left">
                    ...
                    <form action="" method="POST">
                        <div class="input-fields">
                            <input type="text" name="date" class="inputs" placeholder="DD-MMM-YY" value="<?php echo $_POST['date']?>">
                            <input type="number" name="order_id" class="inputs" placeholder="Order ID" min="1000" value="<?php echo $_POST['order_id']?>">
                            <input type="number" name="shop_id" class="inputs" placeholder="Shop ID" value="<?php echo $_POST['shop_id']?>">
                        </div>
                        <div class="buttons">
