    ...
    if (isset($_POST['login'])) {
        ...
        if (($empty_email || $empty_password) != 1) {
            ...
            if ($num == 1) {
                ...
                $sql = "UPDATE USERS SET OTP = '$otp' WHERE USER_ID = '$user'";
                ...
                $message="HERE IS YOUR OTP DETAILS\r\n\r\n";
                $message.="OTP: ".$otp; 
                $header ="From: anjalisubedi83@gmail.com";
        ...
        <div class="log-section">
            ...
            <div class="info-card">
                <div class="info-container">
                    ...
                    <h5><a href="trader/signup.php">Already a trader?</a></h5>
                    <h5>Shopping with us for the first time?</h5>
                    <a href="register.php"><button id="register-btn">Sign Up</button></a>
