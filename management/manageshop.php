<?php
        ...
        $query="SELECT SHOP_ID , SHOP_NAME,SHOP_LOCATION,SHOP_DESC ,FK1_USER_ID,STATUS

        FROM SHOP WHERE 1=1 ORDER BY FK1_USER_ID" ;
                        ...
                        <form action="" method="POST">
                            ...
                            while($value=oci_fetch_assoc($result))
                            {
                                ...
                                <td><?php echo $value['SHOP_ID']?></td>
                                    ...
                                    <td><?php echo $value['SHOP_DESC']?></td>
                                    <td><?php echo $value['FK1_USER_ID']?></td>
                                    
                                    <td>
                                     <?php if($value['STATUS']==1){?>
                                            <a href="shop_status.php?id=<?php echo $value['SHOP_ID']?>">
                                     ...
                                     <?php if($value['STATUS']==0) {?>
                                        <a href="shop_status1.php?id=<?php echo $value['SHOP_ID']?>">
