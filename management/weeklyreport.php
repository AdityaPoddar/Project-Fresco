...
<head>
    ...
    <script src="disable1.js" async></script>
             ...
             <div class="nav">
                ...
                <!-- <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="weeklyreport.php" class="tooltip">Weekly
                            <span class="tooltiptext"><?php  echo date( 'l Y-m-d', strtotime( "previous monday" )); ?> to <?php  echo date( 'l Y-m-d', strtotime( "next monday" )); ?></span>
                        </a>
                        <a href="monthlyreport.php" class="tooltip">Monthly
                            <span class="tooltiptext"><?php  echo date( 'l Y-m-d', strtotime( "first day of this month" )); ?> to <?php  echo date( 'l Y-m-d', strtotime( "first day of next month" )); ?></span>
                        </a>
                    </div>
                </div> -->
                <a href="manageproduct.php">Products</a>
                <a href="adminreport.php">Reviews</a>
    ...
    <!-- -----------------------------------------navbar---------------------------------------------------- -->
        ...
        <section class="dashboard">
            <div class="top-section">
               ...
               <p> <a href="adminreport.php">Reports</a></p>
                </div>
            ...
            <div class="bottom-section">
                    ...
                    <h1>Finance Weekly Report</h1>
                     ...
                     <?php
                        $runner = oci_parse($connection, "SELECT * FROM USERS WHERE USER_TYPE='Trader'");
                        $ern = oci_execute($runner);

                        if($ern)
                        {

                            while($earn = oci_fetch_assoc($runner))
                            {


                                $trader = $earn['USER_ID'];
                                $nmae_trader = $earn['USER_NAME'];
                            // $query1="SELECT * FROM PRODUCT WHERE FK2_USER_ID = '$trader'";
                            // echo $query1;
                        ...
                        if($exe)
                        {
                            while($fetch=oci_fetch_assoc($select))
                            {
                                ...
                                $end = date('m/d/Y', strtotime( "next monday" ));
                                $query="SELECT ORDERDETAIL_QUANTITY,ORDER_DATE
                                        FROM ORDER_DETAIL ord,ORDERS o 
                                        WHERE o.ORDER_ID=ord.FK1_ORDER_ID 
                                        AND FK2_PRODUCT_ID='$pro'";
                                         //echo $query;

                                $find = oci_parse($connection, "SELECT *
                                 FROM ORDER_DETAIL 
                                
                                WHERE FK2_PRODUCT_ID='$pro'");
                                ...
                                if($run)
                                {
...

                                    {
                                        ...
                                        $end = date('m/d/Y', strtotime( "next monday" ));
                                        $start =  date( 'm/d/Y', strtotime( "previous monday" ));
                     ...
                     $runner = oci_parse($connection, "SELECT * FROM USERS WHERE USER_TYPE='Trader'");
                        ...
                        if($exe)
                        {
                            ...
                            {
                                $pro = $fetch['PRODUCT_ID'];
                                // $query="SELECT * FROM ORDER_DETAIL WHERE FK2_PRODUCT_ID='$pro'";
                                // echo $query;
