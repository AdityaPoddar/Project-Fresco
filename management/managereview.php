    ...
    <section class="dashside-container">
        ...
        <section class="main-content">
                ...
                <form action="managereview.php" method="post">
                    <div class="top-left">
                        ...
                        <div class="search-box">
                            <input type="text" name="search-product" placeholder="Product Name" value="<?php echo $search_product?>">
            ...
            if(isset($_POST['search-btn'])){
                ...
                if(  isset($_POST['search-btn']) && empty($_POST['search-product'])){
                ...
                if( isset($_POST['search-btn']) && !empty($_POST['search-product'])){
                    ...
                    $product_query = "SELECT * FROM PRODUCT WHERE PRODUCT_NAME LIKE '%$search_product%'";
                    ...
                    <?php  
                        while($row = oci_fetch_assoc($review_result)){
                            echo "<div class='rows'>
                                ...
                                <p>$row[REVIEW_DATE]</p>
                                <a href='deletereview.php?review-id=$row[REVIEW_ID]'><button class='review-delete-btn'><span class='material-icons'>delete</span></button></a>
                                </div>";
                        }
                    ?>
                </div>
