<?php
        ...
        $query="SELECT USER_ID, USER_NAME, USER_EMAIL ,USER_CONTACT  ,COLLECTIONSLOT_DAY
        FROM USERS u , COLLECTION_SLOT c 
        WHERE u.USER_ID=c.FK1_USER_ID  AND USER_TYPE='CUSTOMER' AND 1=1 "; 
        // echo $query;
            ...
            <div class="bottom-section">
                    ...
                    <div class="button">
                        <form action="manageacc.php" method="POST">
                            <input type= "Submit"  name="Submit"  value="TRADER">
                            <input type= "button"  name="Submit"  value="CUSTOMER" id="btncustomer">
                            <style>
                                .btntcustomer
                                {
                                        cursor:not-allowed;
                            ...
                            while($value=oci_fetch_assoc($result))
                            {
                                ...
                                <td><?php echo $value['USER_ID']?></td>
                                    ...
                                    <td><?php echo $value['COLLECTIONSLOT_DAY']?></td>
