        ...
        <section class="dashboard">
            <div class="addtrader">
             ...
             <div class="form" id="add">
                    ...
                    <form action="producteditupdate.php" method="POST" enctype="multipart/form-data">
                           PROFILE PHOTO: <input type="file" name="file" >
                            NAME:<input type="text" name="fullname"  value="<?php echo $value['PRODUCT_NAME'];?>">
                            PRICE:<input type="integer" name="price"  value="<?php echo $value['PRODUCT_PRICE'];?>">
                            DESCRIPTION:<input type="textbox" name="description" value="<?php echo $value['PRODUCT_DESC'];?>" >                           
