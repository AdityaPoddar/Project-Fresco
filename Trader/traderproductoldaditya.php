<?php
            ...
            $exe=oci_execute($result_shop);
           
            if($exe){
            $shopid=$_POST['Submit'];
            $query="SELECT * FROM PRODUCT WHERE FK1_SHOP_ID='$shopid'";
    ...
    <!-- -----------------------------------------navbar---------------------------------------------------- -->
        ...
        <section class="dashboard">
            ...
            <div class="bottom-section">
                    ...
                    <div class="button">
                        <form action="traderproduct2.php" method="POST">
                      <?php  while($value=oci_fetch_assoc('result_shop')) {?>
                            <input type= "Submit"  name="Submit"  value="<?php echo $value['SHOP_ID'];?>" id="btntrader"  >
                        ...
                        ?>
                                ...
                                <td>
                                     <a href="productedit.php?id=<?php echo $value['PRODUCT_ID'];?>">EDIT</a>
                                     /
                                      <a href="productdelete.php?id=<?php echo $value['PRODUCT_ID'];?>"
