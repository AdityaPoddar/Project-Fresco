        ...
        <section class="dashboard">
            ...
            <div class="main-content">
                <div class="top-section">
                    <div class="three">
                        <div class="sales-info">
                            <p>PRODUCTS SOLD</p>
                            <h2><?php
                                $query = "SELECT COUNT(TOTAL_PRICE) AS count FROM ORDERS where FK3_USER_ID=$traderid ";
                    ...
                    <div class="three">
                        <div class="sales-info">
                            <p>ORDERS</p>
                            <h2><?php
                                $query = "SELECT COUNT(ORDER_ID) AS count FROM ORDERS where FK3_USER_ID=$traderid";
                                $result = oci_parse($connection, $query);
                                oci_execute($result);
                ...
                <div class="bottom-section">
                    <div class="left">
                        <h2 style="color:white;text-align:center;padding: 10px;">Total No Of Product</h2>
                        <h3 style="color:white;text-align:center;padding: 10px;"><?php
                            $query = "SELECT * FROM PRODUCT WHERE FK2_USER_ID ='$traderid'";
                            $result = oci_parse($connection, $query);
                            oci_execute($result); 
                    ...
                    <div class="right">
                        <h2 style="color:white;text-align:center;padding: 10px;">Total No Of Shop</h2>
                        <h3 style="color:white;text-align:center;padding: 10px;"><?php
                            $query = "SELECT * FROM SHOP WHERE FK1_USER_ID ='$traderid'";
                            $result = oci_parse($connection, $query);
                            oci_execute($result); 
