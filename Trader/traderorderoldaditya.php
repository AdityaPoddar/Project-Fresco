<?php
        ...
        $exe=oci_execute($shop_result);
        if(isset($_POST['shopid'])){
            $shopid=$_POST['shopid'];
        
    if($exe){
        $query="SELECT ORDER_ID,ORDER_DATE FROM ORDERS WHERE FK_SHOP_ID='$shopid'";
        ...
        <section class="dashboard">
            ...
            <div class="bottom-section">
                    ...
                    <div class="button">
                        ...
                        <?php while ($row=oci_fetch_assoc($shop_result))  {?>
                            <input type= "Submit"  name="shopid"  value="<?php echo $row['SHOP_ID'];?>" id="ordershop1">
                            <!-- <input type= "Submit"  name="Submit"  value="Shop 2" > -->
