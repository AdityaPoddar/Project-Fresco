<?php
        ...
        $query=oci_parse($connection,"SELECT * FROM USERS WHERE USER_ID='$traderid'");     
        oci_execute($query);     
        $value=oci_fetch_assoc($query);
    ...
    <section class="dashside-container">
        <section class="sidebar" id="sidebar">
            ...
            <div class="nav">
                ...
                <a href="traderorder.php">Orders</a>
                <a href="traderreport.php">Reports</a>
        ...
        <section class="dashboard">
            <div class="addtrader">
             ...
             <div class="form" id="add">
                    ...
                    <form action="traderupdateaccount.php" method="POST" enctype="multipart/form-data">
                        <!-- PROFILE PHOTO:  <input type="file" name="file" > -->
                        FULLNAME: <input type="text" name="fullname"  placeholder="Fullname"  value="<?php echo $value['USER_NAME'];?>">
                            CONTACT:<input type="integer" name="contact"  placeholder="Contact"value="<?php echo $value['USER_CONTACT'];?>">                                           
                           EMAIL: <input type="email" name="email"  placeholder="Email"value="<?php echo $value['USER_EMAIL'];?>">                                                    
                                                
                            DESCRIPTION:<input type="textbox" name="description"  placeholder="Description"value="<?php echo $value['USER_DESC'];?>">                            
                         <input type= "Submit" id="confirm" name="Submit"  value="Confirm">
                            <input type="hidden" name="id" value="<?php echo $traderid ?>">
                            <style>
                                #add{
                                    color:white;
                                    padding:2px;
