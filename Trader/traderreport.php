        ...
        <section class="dashboard">
            ...
            <!-- <div class="bottom-section"> -->
                    ...
                    <!-- <div class="button" id="finance">
                        ...
                        <h3 style=" margin:25px 0 25px 22px; font-size:18px;"><a href="weeklyreport.php" style="color:white; text-decoration:underline;">WEEKLY : ( <span style="font-size:13px;"><?php  echo date( 'l Y-m-d', strtotime( "previous monday" )); ?> to <?php  echo date( 'l Y-m-d', strtotime( "next monday" )); ?> </span>)</a></h3>
                        <h3 style="margin:0px 0 0px 22px; font-size:18px;"><a href="monthlyreport.php" style="color:white; text-decoration:underline;">MONTHLY: ( <span style="font-size:13px;"><?php  echo date( 'l Y-m-d', strtotime( "first day of this month" )); ?> to <?php  echo date( 'l Y-m-d', strtotime( "first day of next month" )); ?></span>)</a></h3>
                    </div> -->

                    <div class="main">
                        <div class="button1">
                        <form action="weeklyreport.php">
                            <input type= "Submit"  name="Submit"  value="Weekly"  class="tooltip">
                            <span class="tooltiptext">
                                <?php  echo date( 'l Y-m-d', strtotime( "previous monday" )); ?>
                                 to <?php  echo date( 'l Y-m-d', strtotime( "next monday" )); ?></span>

                        </form>

                        </div>
                        <div class="button1">
                        <form action="monthlyreport.php">
                                    <input type= "Submit"  name="Submit"  value="Monthly" class="tooltip">
                                    <span class="tooltiptext">
                                        <?php  echo date( 'l Y-m-d', strtotime( "first day of this month" )); ?> to 
                                        <?php  echo date( 'l Y-m-d', strtotime( "first day of next month" )); ?></span>
                        </form>     
                        </div>
                    </div>
            <!-- </div> -->
